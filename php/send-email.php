<?php	
	// Your Email
	$recipient = "eberhard.luecke@archidevelop.de"; // PLEASE SET YOUR EMAIL ADDRESS
	...
	if ( empty($lname) ){
		$lname = "Bitte geben Sie ihren Namen ein.";
	}
	if ( empty($website) ){
		$website = "Bitte tragen Sie ihre Webseite ein.";
	}
	...
	// Build Message
	$email_content = "Vorname: $fname\n";
	$email_content .= "Nachname: $lname\n";
